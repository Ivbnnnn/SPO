...
export default function Header() {          
  return (
    <div className='flex text-accent-2'>
        <div className='max-w-[30vw] min-w-[15vw] flex justify-center bg-gray items-center hover:active'>
          <Link to='/'>
            <svg
            ...
            >
                ...
                <g>
                  <path class="cls-1" d="M.45,113.21c3.55,2.61,50.38,3.65,71.89-6.55,21.75-10.32,32.74-22.84,52.74-27.27,33.59-7.43,65.4,13.4,62,12.53-7.53-1.94-27.07-9.66-58.34.83-14.31,4.8-18.48,7.51-35.06,17.37-21.2,12.6-31.33,15.23-51.12,16.05-23.08.96-46.08-15.88-42.1-12.95Z"/>
                  <path class="cls-1" d="M94.12,126.97c3.55,2.61,50.38,3.65,71.89-6.55,21.75-10.32,32.74-22.84,52.74-27.27,33.59-7.43,65.4,13.4,62,12.53-7.53-1.94-27.07-9.66-58.34.83-14.31,4.8-18.48,7.51-35.06,17.37-21.2,12.6-31.33,15.23-51.12,16.05-23.08.96-46.08-15.88-42.1-12.95Z"/>
                </g>
                <g>
                  <path class="cls-1" d="M276.27,168.58c10.5,7.19,25.08,12.3,40.7,12.3,27.84,0,44.91-15.82,44.91-38.76,0-20.86-10.85-33.16-37.73-43.53-29.98-10.64-47.95-26.05-47.95-51.41,0-27.29,22.52-47.19,54.17-47.19,17.48,0,30.75,4.49,37.1,8.77l-5.11,11.06c-5.04-3.52-16.93-8.84-32.89-8.84-30.05,0-40.28,19.28-40.28,33.92,0,20.66,11.95,31.23,38.62,41.66,30.75,12.44,47.05,26.39,47.05,54.31s-19.35,51.2-59.08,51.2c-16.1,0-34.82-5.25-44.49-12.51l4.97-10.98Z"/>
                  ...
                  <path class="cls-1" d="M545.62,88.23c0-12.16-.42-21.28-1.11-31.71h12.23l.97,23.97h.55c7.26-14.92,23.91-27.02,45.67-27.02,12.65,0,46.29,6.49,46.29,56.17v79.53h-13.13v-78.35c0-24.18-9.33-46.09-36.76-46.09-18.66,0-34.55,13.34-39.8,30.54-.97,3.18-1.8,7.67-1.8,11.82v82.08h-13.13v-100.95Z"/>
        ...
        <div className='bg-beige-2 w-screen flex justify-between border-b border-accent-1'>          
          <div className='relative w-full max-w-lg my-6' >
              ...
              <input type="text" placeholder='Поиск' id="mainSearch"
