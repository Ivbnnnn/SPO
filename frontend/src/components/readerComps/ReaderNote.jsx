...
export default function ReaderNote({page, text}) {
  return (
    <div className='flex flex-col h-min-[10%] rounded-xl bg-beige-1 text-blue p-4 mx-4 my-2'>
        <div className='flex justify-end'>
            <p className='text-xs'>стр. {page}</p>    
            </div>
